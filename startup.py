""" 
In this sample, the Flask app object is contained within the indicators_app *module*;
that is, indicators_app contains an __init__.py along with relative imports. Because
